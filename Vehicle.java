...
public class Vehicle implements Comparable<Vehicle>, Serializable {
    ...
    public Vehicle(String name,double x,long y,String creationdate ,float enginePower,long numberOfWheels, String type, String fuelType) throws VehicleTypeException, FuelTypeException {
    ...
    public Vehicle(Scanner scanner){
        ...
        while (this.enginePower==null) {
            ...
            try {this.setEnginePower(Engine);} catch (EnginePowerException E){
                //System.err.println(E);
                }
        }
